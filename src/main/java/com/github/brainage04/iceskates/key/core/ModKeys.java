package com.github.brainage04.iceskates.key.core;
...
public class ModKeys {
    public static final KeyMapping.Category MAIN_CATEGORY = new KeyMapping.Category(Identifier.fromNamespaceAndPath(IceSkates.MOD_ID, "main"));

    public static final KeyMapping TEST_KEY = KeyBindingHelper.registerKeyBinding(new KeyMapping(
            "key.%s.testKey".formatted(IceSkates.MOD_ID),
